...
public class Durant_JF_7_4_3 {
    public void main(String[] args) {
        Student adam = new Student("Adam", "Cain", new Date(), "Computers", Year.of(2026));

        System.out.println("Student Created: " + adam.getName() + "\n");
        System.out.println("Major: " +adam.getMajor());

        adam.setMajor("IT");
        System.out.println("Major: " + adam.getMajor());

        adam.inputGpa(); // to input grades
        }
